...
const insertPorto = (data) => {
    const { porto_id, worker_id, porto_name, link_repo, porto_photo } = data;
    const query = `
      INSERT INTO portofolio(porto_id, worker_id, porto_name, link_repo, porto_photo) 
      VALUES ($1, $2, $3, $4, $5)
    `;
    const values = [porto_id, worker_id, porto_name, link_repo, porto_photo];
