  ...
  registerWorker: async (req, res) => {
    try {
      const workerSchema = Joi.object({
        ...
        worker_phone: Joi.string().required(),
        worker_photo: Joi.string().required(),
        worker_pass: Joi.string().required(),
        worker_confirm_pass: Joi.string().required().valid(Joi.ref('worker_pass')),
      });
      ...
      const { worker_name, worker_email, worker_phone, worker_photo, worker_confirm_pass } = req.body;
      ...
      const data = {
        ...
        worker_phone,
        worker_photo,
        worker_pass: worker_confirm_pass,
        passwordHash,
      };
